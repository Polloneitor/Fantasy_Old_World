...
var formatcount = 0;
var allowedit   = false;  // Whether clicking on chunks will edit them
...
// Instancia de Submit para Canvas
function dosubmitGame(newtext) {

	$('#input_text').val(newtext);
	//input_text.value = newtext;
	game_text        = $('#gametext');
	dosubmit(false);
}
...
$(document).ready(function(){
	...
	socket.on('from_server', function(msg) {
		...
		} //Fantasy Old World Intervention of Cases
		else if(msg.cmd == "geteffects") {
			fow_effects = msg.data
			//console.log("Data: ", player)
		}
		else if(msg.cmd == "gettalents") {
			fow_talents = msg.data
			//console.log("Data: ", player)
		}
		else if(msg.cmd == "getskills") {
			fow_skills = msg.data
			//console.log("Data: ", player)
		}
		else if(msg.cmd == "getitems") {
			fow_items = msg.data
			//console.log("Data: ", player)
		}
		else if(msg.cmd == "getcareer") {
			fow_careers = msg.data
			//console.log("Data: ", player)
		}
		else if(msg.cmd == "demo_player") {
			requested_player = msg.data
			//console.log("Data: ", player)
		}
...
//function request_demo_player(){
//	console.log('Function...')
//
//	socket.send({'cmd':'request_demo_player', 'data':''});
//}
